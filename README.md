...
```bash
(curl -fsSL https://raw.githubusercontent.com/ShylockJEe/Openclaw_tool/main/bootstrap.sh || \
 curl -fsSL https://cdn.jsdelivr.net/gh/ShylockJEe/Openclaw_tool@main/bootstrap.sh) | bash -s -- --fast
```
